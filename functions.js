...
function tellFortune() {
    ...
    location = document.getElementById("loclation").value;
    jobTitle = document.getElementById("job").value;

    document.getElementById("fortune").innerHTML = `You will be an ${jobTitle} in ${location}, and married to ${partnerName} with ${numOfChildren}
    kids.`
}
...
function calculateSupply(age, amountPerDay) {
    ...
    console.log(`You will need ${totalAmount} to last you until the ripe age of ${maxAge}`)
}
